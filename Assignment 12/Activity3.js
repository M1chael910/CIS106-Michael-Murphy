...
// and prints it. The program prints the score in decending order 
// After the scores are printed, the program asks the user if they would 
// like to continue, and repeats the program if the user enters all positive values. 
// The program also sorts the scores in decending order and prints the them  
